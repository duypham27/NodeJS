        ...
        try {
            ...
            if (checkObj.isValid === false) {
                ...
                if (doctorInfor) {
                    ...
                    doctorInfor.clinicIdId = inputData.clinicIdId;
                ...
                resolve({
                    errCode: 0,
                    errMessage: 'Save info doctor info success!'
                })
            }
    ...
    return new Promise(async (resolve, reject) => {
        try {
            if (!inputId) {
                ...
                if (data && data.image) {
                    data.image = new Buffer(data.image, 'base64').toString('binary'); // Convert base64 to binary
                }
